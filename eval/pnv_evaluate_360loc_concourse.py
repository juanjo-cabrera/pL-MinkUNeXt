...
def evaluate(model, device, log: bool = False, show_progress: bool = False):
    ...
    eval_database_files = ['concourse_daytime_360_0_360loc_evaluation_database.pickle', 'concourse_daytime_360_2_360loc_evaluation_database.pickle', 'concourse_nighttime_360_0_360loc_evaluation_database.pickle']
    eval_query_files = ['concourse_daytime_360_0_360loc_evaluation_query.pickle', 'concourse_daytime_360_2_360loc_evaluation_query.pickle', 'concourse_nighttime_360_0_360loc_evaluation_query.pickle']
...
if __name__ == "__main__":
    ...
    PARAMS.test_folder = '/media/arvc/DATOS1/Marcos/DATASETS/360LOC/concourse'
    ...
    pnv_write_eval_stats("/home/arvc/Juanjo/develop/DepthMinkUNeXt/training/results_concourse.txt", prefix, stats)
