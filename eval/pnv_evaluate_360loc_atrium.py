...
def evaluate(model, device, log: bool = False, show_progress: bool = False):
    ...
    eval_database_files = ['atrium_daytime_360_1_360loc_evaluation_database.pickle', 'atrium_daytime_360_2_360loc_evaluation_database.pickle', 'atrium_nighttime_360_1_360loc_evaluation_database.pickle', 'atrium_nighttime_360_2_360loc_evaluation_database.pickle']
    eval_query_files = ['atrium_daytime_360_1_360loc_evaluation_query.pickle', 'atrium_daytime_360_2_360loc_evaluation_query.pickle', 'atrium_nighttime_360_1_360loc_evaluation_query.pickle', 'atrium_nighttime_360_2_360loc_evaluation_query.pickle']
    ...
    for query_file in eval_query_files:
        location_name = query_file.split('_')[0] + '_' + query_file.split('_')[1] + '_' + query_file.split('_')[3] 
...
if __name__ == "__main__":
    ...
    PARAMS.test_folder = '/media/arvc/DATOS1/Marcos/DATASETS/360LOC/atrium'
    ...
    PARAMS.weights_path = '/media/arvc/DATOS1/Juanjo/weights/DepthMinkunext/aiai_weights/Indoor_MinkUNeXt_pos_per_query16batch_size512_truncated_aug6depths0.4pos0.4neg0.4voxel_size0.05height-0.25_20250408_0112_best_test.pth'
    ...
    if PARAMS.use_magnitude_hue or PARAMS.use_magnitude_ones or PARAMS.use_anglexy:
        ...
        model = MinkUNeXt(in_channels=6, out_channels=512, D=3)
    elif PARAMS.use_magnitude_anglexy_hue_rgb:
        model = MinkUNeXt(in_channels=7, out_channels=512, D=3)
    else: 
    ...
    pnv_write_eval_stats("/home/arvc/Juanjo/develop/DepthMinkUNeXt/training/results_atrium.txt", prefix, stats)
