...
def evaluate(model, device, log: bool = False, show_progress: bool = False):
    ...
    eval_database_files = ['hall_daytime_360_1_360loc_evaluation_database.pickle', 'hall_daytime_360_2_360loc_evaluation_database.pickle', 'hall_nighttime_360_1_360loc_evaluation_database.pickle', 'hall_nighttime_360_2_360loc_evaluation_database.pickle']
    eval_query_files = ['hall_daytime_360_1_360loc_evaluation_query.pickle', 'hall_daytime_360_2_360loc_evaluation_query.pickle', 'hall_nighttime_360_1_360loc_evaluation_query.pickle', 'hall_nighttime_360_2_360loc_evaluation_query.pickle']
...
if __name__ == "__main__":
    ...
    PARAMS.test_folder = '/media/arvc/DATOS1/Marcos/DATASETS/360LOC/hall'
    ...
    pnv_write_eval_stats("/home/arvc/Juanjo/develop/DepthMinkUNeXt/training/results_hall.txt", prefix, stats)
