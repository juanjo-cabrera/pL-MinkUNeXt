...
def evaluate(model, device, log: bool = False, show_progress: bool = False):
    ...
    eval_database_files = ['piatrium_daytime_360_0_360loc_evaluation_database.pickle', 'piatrium_daytime_360_1_360loc_evaluation_database.pickle', 'piatrium_nighttime_360_0_360loc_evaluation_database.pickle']
    eval_query_files = ['piatrium_daytime_360_0_360loc_evaluation_query.pickle', 'piatrium_daytime_360_1_360loc_evaluation_query.pickle', 'piatrium_nighttime_360_0_360loc_evaluation_query.pickle']
...
if __name__ == "__main__":
    ...
    PARAMS.test_folder = '/media/arvc/DATOS1/Marcos/DATASETS/360LOC/piatrium'
    ...
    pnv_write_eval_stats("/home/arvc/Juanjo/develop/DepthMinkUNeXt/training/results_piatrium.txt", prefix, stats)
