...
def evaluate(model, device, log: bool = False, show_progress: bool = False):
    ...
    eval_query_files = ['cloudy_evaluation_query.pickle', 'sunny_evaluation_query.pickle']
...
if __name__ == "__main__":
    ...
    PARAMS.dataset_folder = '/media/arvc/DATOS/Juanjo/Datasets/PCD_non_metric_FRIBURGO_B'
    ...
    pnv_write_eval_stats("/home/arvc/Juanjo/develop/IndoorMinkUnext/training/results_friburgo_b.txt", prefix, stats)
