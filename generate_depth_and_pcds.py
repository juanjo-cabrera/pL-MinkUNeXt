...
def process_image_and_pcd(model, lama_model, image_path, src_color_dir, depth_dir, pcd_dir):
    ...
    for root, dirs, files in os.walk(src_color_dir):
        ...
        for file in files:
            ...
            if file.lower().endswith(('.png', '.jpg', '.jpeg', '.bmp', '.gif')):
                process_image_and_pcd(model, lama_model, src_file_path, src_color_dir, depth_dir, pcd_dir)
